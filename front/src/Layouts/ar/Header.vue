<template>
  ...
  >
    <div class="flex items-center justify-start">
      ...
      <div class="relative flex items-center justify-start full">
        <input
          ...
          class="bg-[#F3F4F6] rounded-full py-2 focus:border-teal-500 focus:outline-none pr-12 w-[300px] text-[#445045]"
        />
        <button
          @click="this.getSearchData()"
          class="absolute inset-y-0 right-0 flex items-center justify-center bg-[#9ED5CB] w-[40px] rounded-full"
        >
          <svg
    ...
    <div class="flex items-center justify-end px-3 gap-2">
      ...
      <div class="bg-[#9ED5CB] px-3 py-3 rounded-full text-[#fff] relative">
        ...
        <div
          class="absolute inset-y-0 left-0 top-[-5px] flex items-center justify-center bg-[#545F55] h-[14px] w-[14px] rounded-full px-2 py-2"
        >
      ...
      >
        ...
        />
        <div
          class="absolute left-0 bottom-0 flex items-center justify-center bg-[#545F55] h-[14px] w-[14px] rounded-full px-1 py-1 text-[#fff]"
        >
          <svg
            viewBox="0 0 16 16"
            width="12"
  ...
  <div
    class="w-[200px] flex flex-col items-center justify-center absolute left-[10px] top-[60px] rounded bg-[#fff] shadow-2xl z-99999"
    v-show="this.showSetting == true"
    ref="profileMenu"
  >
    <div
      class="flex flex-col items-center justify-flex-start py-4 w-full"
      dir="rtl"
    >
      <RouterLink
        to="/"
      ...
      >
        <div class="flex items-center gap-2 px-2">
          ...
          ></i>
          <p class="font-bold text-[14px]">حسابي</p>
        </div>
        <div class="flex items-center px-2">
          <i
            class="pi pi-arrow-left text-[16px] text-[#445045] rounded-full"
          ></i>
        </div>
      </RouterLink>
      ...
      >
        <div class="flex items-center gap-2 px-2">
          ...
          ></i>
          <p class="font-bold text-[14px]">تسجيل الخروج</p>
        </div>
        <div class="flex items-center px-2">
          <i
            class="pi pi-arrow-left text-[16px] text-[#445045] rounded-full"
